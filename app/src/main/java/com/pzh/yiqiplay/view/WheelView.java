...
public class WheelView extends ScrollView {
    ...
    private void initData() {
        ...
        if (currentIndex != -1) {
            smoothScrollTo(0, itemHeight * currentIndex);
        }
    ...
    private int getViewMeasureHeight(View view) {
        ...
        int ex = View.MeasureSpec.makeMeasureSpec(Integer.MAX_VALUE >> 2, MeasureSpec.AT_MOST);
        ...
        public void run() {
            wheelContainer.post(new Runnable() {
                ...
                public void run() {
                    ...
                    WheelView.this.smoothScrollTo(0, (int) textViewList.get(currentIndex).getY());
                    onWheelViewSelected.onSelected(currentIndex, wheelLists.get(currentIndex + visibleCount / 2));
                }
            });
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        if (viewWidth == 0) {
            viewWidth = (int) AppConfig.Src_width;
        }
        if (paint == null) {
            paint = new Paint();
